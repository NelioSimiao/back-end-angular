...
public class ExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex,
		...
		// String mensagem = messageSource.getMessage("recurso nao encontado", null,
		// LocaleContextHolder.getLocale());
		String devMessage = ex.toString();

		List<Erro> erros = Arrays.asList(new Erro("recurso nao encontado", devMessage));
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(DataIntegrityViolationException ex,
		...
		List<Erro> erros = Arrays.asList(new Erro("Operecao nao permetida", devMessage));
